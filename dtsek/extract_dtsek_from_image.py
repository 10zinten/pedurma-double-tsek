...
__all__ = ['get_templates', 'mtm', 'templates', 'get_ocr_output', 'get_symbol', 'get_full_text_annotations',
           'resize_boxes', 'cls_box_into_line', 'find_double_tsek_bf', 'compute_iou', 'get_double_tsek_idx',
           'put_whitespaces', 'rm_running_head', 'rm_noise', 'postprocess', 'str_insert', 'add_double_tsek',
           'extract_double_tsek_vol', 'get_double_tsek_vol_by_pages', 'main']
